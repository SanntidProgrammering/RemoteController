...
public class GUIController extends TimerTask {
    ...
    public void run() {
        ...
        if (!this.datahandler.isTrackFeedbackActive()) {
            this.datahandler.incrementRequestCode();
        }
    }

    public void setTimeStamp(long time) {
        this.datahandler.setATimeStamp(time);
        this.datahandler.setRequestCode((byte) -99);
    }

    /**
     * Sets or releases the FWD bit in the Byte array in datahandler. Run
     * forward or stop running fwd. Used for manual driving.
     *
    ...
    /**
     * Sets or releases the Left bit in the Byte array in datahandler. Turn left
     * or stop turn left. Used for manual driving.
     *
     * @param value boolean to decide to set (True) or release (False)
     */
    ...
    /**
     * Sets or releases the REV bit in the Byte array in datahandler. Run
     * reverse or stop running reverse. Used for manual driving.
     *
     * @param value boolean to decide to set (True) or release (False)
     */
    ...
    /**
     * Sets or releases the Right bit in the Byte array in datahandler. Turn
     * right or stop turning right. Used for manual driving.
     *
     * @param value boolean to decide to set (True) or release (False)
     */
